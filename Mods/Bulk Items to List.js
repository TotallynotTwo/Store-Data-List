...
subtitle: function(data) {
	...
	return `Add "${data.intn}" to ${storage[parseInt(data.storage)]} (${data.varName})`;
},
...
<div><br><br>
	List:<br>
	<input id="intn" class="round" style="width: 125%;" type="text" placeholder="Ex. 52,42,61,65"><br>
</div>
	</div>
...
action: function(cache) {
    ...
    var integer = this.evalMessage(data.intn, cache);
